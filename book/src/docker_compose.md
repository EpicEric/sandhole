...
An example configuration is provided in the repository's [docker-compose-example/sandhole](https://codeberg.org/sandhole/sandhole/src/branch/main/docker-compose-example/sandhole) directory, using `sandhole.com.br` as the example domain. Copy the `compose.yml` and `config.toml` files to the desired directory, and adjust them as necessary.
...
An alternate configuration using [dnsrobocert](https://adferrand.github.io/dnsrobocert/) is available under [docker-compose-example/sandhole-dnsrobocert](https://codeberg.org/sandhole/sandhole/src/branch/main/docker-compose-example/sandhole-dnsrobocert) in the repository.
