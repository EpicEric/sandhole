...
pub struct ApplicationConfig {
    ...
    /// How many remote forwarding connections should be available at most per service.
    ///
    /// A high value may cause starvation of resources on both Sandhole and the services.
    #[arg(long, default_value_t = 10, value_name = "VALUE")]
    ...
    pub proxy_pool_timeout: Duration,
    ...
    fn parses_minimal_args() {
        ...
        assert_eq!(
            ...
            ApplicationConfig {
                ...
                ssh_keepalive_max: 3,
                proxy_pool_capacity: 5,
                proxy_pool_timeout: Duration::from_secs(20),
    ...
    fn parses_full_args() {
        ...
        assert_eq!(
            ...
            ApplicationConfig {
                ...
                proxy_pool_timeout: Duration::from_secs(0),
