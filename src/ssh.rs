...
use crate::{
    ...
    ssh_forwarding::{Forwarder, LocalForwardingContext, RemoteForwardingContext},
    tcp_alias::TcpAlias,
};
...
pub(crate) struct ProxyAutoCancellation {
    ...
    pub(crate) proxy_count: Arc<AtomicUsize>,
        ...
        ServerHandler {
            ...
            auth_data: AuthenticatedData::None {
                proxy_data: Box::new(ProxyAutoCancellation {
                    ...
                    proxy_count: Arc::new(AtomicUsize::new(1)),
