...

{
  options = {
    services.sandhole = {
      ...
      settings = {
        ...
        userKeysDirectory = lib.mkOption {
          type = types.path;
          ...
          '';
          example = lib.literalExpression "./deploy/user_keys/";
        };

        adminKeysDirectory = lib.mkOption {
          type = types.path;
          ...
          description = ''
            ...
            Each file must contain at least one key.
          '';
          example = lib.literalExpression "./deploy/admin_keys/";
        };

        certificatesDirectory = lib.mkOption {
          type = types.path;
          ...
          '';
          example = lib.literalExpression "./deploy/certificates/";
        };

        acmeCacheDirectory = lib.mkOption {
          type = types.path;
          ...
          '';
          example = lib.literalExpression "./deploy/acme_cache/";
        };
        ...
        privateKeyFile = lib.mkOption {
          ...
          '';
          example = lib.literalExpression "./deploy/server_keys/ssh";
        };

        disableDirectoryCreation = lib.mkOption {
          type = types.bool;
          default = false;
          description = ''
        ...
        connectSshOnHttpsPort = lib.mkOption {
          type = types.bool;
          default = false;
          description = ''
        ...
        passwordAuthenticationUrl = lib.mkOption {
          type = types.nullOr types.str;
          default = null;
          description = ''
        ...
        loadBalancingAlgorithm = lib.mkOption {
          type = types.nullOr (
            types.enum [
              "random"
              "round-robin"
        ...
        allowRequestedSubdomains = lib.mkOption {
          type = types.bool;
          default = false;
          description = ''
        ...
        allowRequestedPorts = lib.mkOption {
          type = types.bool;
          default = false;
          description = ''
            Allow user-requested subdomains.
        ...
        disablePrometheus = lib.mkOption {
          type = types.bool;
          default = false;
          description = ''
        ...
        randomSubdomainValue = lib.mkOption {
          type = types.nullOr types.ints.positive;
          default = null;
          description = ''
        ...
        randomSubdomainSeed = lib.mkOption {
          type = types.nullOr (
            types.enum [
              "ip-and-user"
              "user"
        ...
        randomSubdomainLength = lib.mkOption {
          type = types.nullOr types.ints.positive;
          default = null;
        ...
        randomSubdomainFilterProfanities = lib.mkOption {
          type = types.bool;
          default = false;
        ...
        requestedDomainFilterProfanities = lib.mkOption {
          type = types.bool;
          default = false;
          description = ''
        ...
        requestedSubdomainFilterProfanities = lib.mkOption {
          type = types.bool;
          default = false;
          description = ''
        ...
        sshKeepaliveInterval = lib.mkOption {
          type = types.nullOr types.str;
          default = null;
          description = ''
        ...
        idleConnectionTimeout = lib.mkOption {
          type = types.nullOr types.str;
          default = null;
          description = ''
        ...
        unproxiedConnectionTimeout = lib.mkOption {
          type = types.nullOr types.str;
          default = null;
          description = ''
        ...
        authenticationRequestTimeout = lib.mkOption {
          type = types.nullOr types.str;
          default = null;
          description = ''
        ...
        httpRequestTimeout = lib.mkOption {
          type = types.nullOr types.str;
          default = null;
          description = ''
        ...
        tcpConnectionTimeout = lib.mkOption {
          type = types.nullOr types.str;
          default = null;
          description = ''
  ...
  config = lib.mkIf cfg.enable {
          ...
          ExecStart =
            let
              args = lib.cli.toGNUCommandLineShell { } (
                ...
                // lib.optionalAttrs (cfg.settings.ipAllowlist != [ ]) {
                  ip-allowlist = lib.strings.concatStringsSep "," cfg.settings.ipAllowlist;
                }
                // lib.optionalAttrs (cfg.settings.ipBlocklist != [ ]) {
                  ip-blocklist = lib.strings.concatStringsSep "," cfg.settings.ipBlocklist;
                }
              );
            in
    ...
    networking.firewall = lib.mkIf cfg.openFirewall {
      ...
      allowedTCPPortRanges = lib.optional (!cfg.settings.disableTcp) {
        from = 1024;
        to = 65535;
      };
    };
